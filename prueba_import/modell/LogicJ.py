...
class LogicJuego:
    ...
    def __init__(self, tablero_jugador, tablero_maquina):
        ...
        cadena_conexion = "postgresql://BattleShip_owner:0XuBfor6mAEa@ep-gentle-water-a5djsrmk.us-east-2.aws.neon.tech/BattleShip?sslmode=require"
        self.bd = BD(cadena_conexion)
